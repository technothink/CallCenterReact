    ...
    prepareTableRow=(tableData)=>{
        ...
        for(let index in tableData){
          console.log('iterarting',tableData[index]);
            tableBody[index] = <TableRow clicked={this.props.SpeakerHandler}
             jobName={tableData[index].jobName} sentiment={tableData[index].sentiment} 
             status={tableData[index].status} key={index} 
